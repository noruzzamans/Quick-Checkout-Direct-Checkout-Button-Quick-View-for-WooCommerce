	...
	public function qcwf_checkout_buy_now_settings(){
		return array(
			array(
				...
				'name' => esc_html__( 'Products archive/shop page', 'qcfw-checkout' ),
				'type' => 'title',
			),
			array(
			...
			array(
				...
				'name' => esc_html__( 'Buy now button backguound hover color', 'qcfw-checkout' ),
				'desc_tip' => esc_html__( 'Buy now button backguound hover color', 'qcfw-checkout' ),
				'type'     => 'color',
				'default'  => '#eb7a61',
			),
			array(
			...
			array(
				...
				'name' => esc_html__( 'Buy now button text hover color', 'qcfw-checkout' ),
				'desc_tip' => esc_html__( 'Buy now button text hover color', 'qcfw-checkout' ),
				'type'     => 'color',
				'default'  => '#ffffff',
			),
			array(
