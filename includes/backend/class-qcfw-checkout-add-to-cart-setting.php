	...
	public function qcwf_checkout_add_to_cart_settings(){
		return array(
			array(
				...
				'name' => esc_html__( 'Add To Cart Button Text For Archive/Shop Pages', 'qcfw-checkout' ),
				'type' => 'title',
			),
			array(
				'id'   => 'qcwf_checkout_shop_simple_add_to_cart_btn',
				'name' => esc_html__( 'Simple product', 'qcfw-checkout' ),
				'desc_tip' => esc_html__( 'Update shop page simple product add to cart button text', 'qcfw-checkout' ),
				'type'     => 'text',
				'default'  => 'Add to cart',
			),
			array(
				'id'   => 'qcwf_checkout_shop_variable_add_to_cart_btn',
				'name' => esc_html__( 'Variable product', 'qcfw-checkout' ),
				'desc_tip' => esc_html__( 'Update shop page variable product add to cart button text', 'qcfw-checkout' ),
				'type'     => 'text',
				'default'  => 'Select options',
			),
			array(
				'id'   => 'qcwf_checkout_shop_grouped_add_to_cart_btn',
				'name' => esc_html__( 'Grouped product', 'qcfw-checkout' ),
				'desc_tip' => esc_html__( 'Update shop page grouped product add to cart button text', 'qcfw-checkout' ),
				'type'     => 'text',
				'default'  => 'View products',
			),
			array(
				'id'   => 'qcwf_checkout_shop_external_add_to_cart_btn',
				'name' => esc_html__( 'External/Affiliate product', 'qcfw-checkout' ),
				'desc_tip' => esc_html__( 'Update shop page external/affiliate product add to cart button text', 'qcfw-checkout' ),
				'type'     => 'text',
				'default'  => 'Buy product',
			),
			array(
			...
			array(
				...
				'name' => esc_html__( 'Add To Cart Button Text For Single Page', 'qcfw-checkout' ),
				'type' => 'title',
			),
			array(
